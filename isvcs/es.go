...
func initElasticSearch() {
	...
	es_global_PortBinding := portBinding{
		HostIp:         "0.0.0.0",
		HostIpOverride: "SERVICED_ISVC_ELASTICSEARCH_SERVICED_PORT_9200_HOSTIP",
		HostPort:       9200,
	}
	...
	defaultHealthCheck := healthCheckDefinition{
		healthCheck: esHealthCheck(getHostIp(es_global_PortBinding), 9200, ESYellow),
	...
	elasticsearch_serviced, err = NewIService(
		IServiceDefinition{
			...
			PortBindings:   []portBinding{es_global_PortBinding},
